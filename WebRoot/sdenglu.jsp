	...
	-->
      <style type="text/css">
          body{
              margin:0;
              padding:0;
              background-image: url("resources/images/carousel/1.jpg");
          }
          .div1{
...
<body>
  <%--<div class="div1">--%>
    <div class="div2_1">
        ...
        <%--</div>--%>
        <div class="div3_2">
             <span>Examination 考试答题系统</span>
        </div>
    </div>
    <div class="div2_2">
     <center>
     
    	<form class="form" id="form1" action="${pageContext.request.contextPath }/student_login.action" method="post" onsubmit="return checkForm()" >
        	<table border="0px">
            	<tr>
